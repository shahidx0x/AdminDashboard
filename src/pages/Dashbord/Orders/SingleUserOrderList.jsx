...
// import { Breadcrumb, Divider, Panel, Table } from "rsuite";
...
//     ["orders", page, user.jwt, params.user],
//     getOrders,
//     {
//       cacheTime: 0,
//       manual: true,
...
//               </Breadcrumb.Item>
//             </Breadcrumb>
//             <h2 className="text-4xl font-bold">Order Details of user</h2>
//             <p className="font-mono mt-2">User id : </p>
//           </div>
//         }
//         bordered
//       >
...
//           <Panel bordered className="w-full">
//             <div
//               className="mt-5 ml-5"
...
export default function SingleUserOrderList() {
  ...
  } = useQuery(["orders", page, user.jwt, params.user], getOrders, {
    cacheTime: 0,
    manual: true,
  });
    ...
    header={
      <div>
        <Breadcrumb className="text-sm font-mono">
          ...
          <h2 className="text-4xl font-bold">Orders History</h2>
      </div>
    }
    bordered
